...
PROCESSED_NTUPLE_DIR="/exp/uboone/app/users/dinupa/dev_v26_04_20/xsec_analyzer/data"
UNIV_OUTPUT_FILE=${PROCESSED_NTUPLE_DIR}"/Universes.root"

MEASUREMENT_OUTPUT_FILE="/exp/uboone/app/users/dinupa/dev_v26_04_20/xsec_analyzer/outputs"
...
SYST_CONFIG="./configs/systcalc_nc1p.conf"
